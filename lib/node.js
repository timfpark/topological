...
const messagesBuffered = new promClient.Counter({ name: 'topological_messages', help: 'Total messages buffered to processors.' });
const messagesProcessed = new promClient.Counter({ name: 'topological_messages', help: 'Total messages buffered to processors.' });
