...
class Node {
    ...
    dequeueInputMessage(input, callback) {
        this.waitOnOutstandingMessages(err => {
            ...
            input.dequeue((err, message) => {
                ...
                this.incrementOutstandingMessages();
    ...
    decrementOutstandingMessages() {
        ...
        if (this.paused && this.targetParallelism && this.outstandingMessages < this.targetParallelism) {
    ...
    processMessage(input, message) {
        ...
        async.whilst(
            ...
            retryCallback => {
                ...
                this.decrementOutstandingMessages();
